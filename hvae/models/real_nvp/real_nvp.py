...
class RealNVP_Big(nn.Module):
    ...
    def __init__(self, num_scales=2, in_channels=3, mid_channels=64, num_blocks=8):
        super(RealNVP_Big, self).__init__()
        ...
        self.flows = _RealNVP_Big(0, num_scales, in_channels, mid_channels, num_blocks)

    def forward(self, x, reverse=False):
        sldj = 0  #! None creates on changing reverse behaviour
        #TODOD: commenting so that it's reverse mode can be used like direct mode. 
        # if not reverse:
...
class _RealNVP_Big(nn.Module):
    ...
    def __init__(self, scale_idx, num_scales, in_channels, mid_channels, num_blocks):
        super(_RealNVP_Big, self).__init__()
        ...
        if self.is_last_block:
            ...
            self.next_block = _RealNVP_Big(scale_idx + 1, num_scales, 2 * in_channels, 2 * mid_channels, num_blocks)
