dataset=celeba_64
CHECKPOINT_DIR=output/$dataset/eval-ltnt_scl20-grp_per_scl5-ltnt_per_grp20/
DATA_DIR=$CHECKPOINT_DIR/feats
EXPR_ID=eval-ltnt_scl20-grp_per_scl5-ltnt_per_grp20
num_groups_per_scale_list="5 5 5" # For celeba
mid_chnls=40
num_blks=2
lrD=3e-4
lrF=5e-5
...
disc_dir=output/$dataset/evalp/$EXPR_ID/ebmConv4_1-Fnet2_smallInCouplng-nscl2--beta1.5-midchn$mid_chnls-nblk$num_blks-lrD$lrD-lrF$lrF-klwt$klwt-wtdcay$wtdcay/seed$seed
 ...
 python train_evalp_celeba64.py --data_dir $DATA_DIR/ \
    --root_dir ./ \
    ...
    --group_idx 0 --train_batch_size 64 --num_fid_samples 20000 \
